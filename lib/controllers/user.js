              ...
              CityService.get(global.Player.uid, global.Player.realm, (data) => {
               ...
               CityService.getCityBuildings(City.id, (data) => {
                ...
                var houseProd = 0,
                 ...
                 siegeProd = Game.baseProduction.siege
                ...
                for(var i = 0; i < Buildings.length; i++){
                 ...
                 switch(type){
                  ...
                  case 7:
                   ...
                   break;
                  case 8:
                   siegeProd -= (Game.buildingBonus.siege * Buildings[i].level);
                   break;
                  case 9:
                ...
                CityService.getFieldBuildings(City.id, (data) => {
                 ...
                 var millProd = Game.baseProduction.mill,
                ...
                for(var i = 0; i < Buildings.length; i++){
                 ...
                 switch(type){
                  case 2:
                   ...
                   break;
                  case 3:
                   millProd += (Game.buildingBonus.mill * Buildings[i].level) + Game.baseProduction.mill;
                   break;
                  case 4:
                ...
                global.Production.mill = millProd;
